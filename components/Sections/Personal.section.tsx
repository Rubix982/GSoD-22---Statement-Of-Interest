...
const Personal: NextComponentType = () => {
  return (
    <div
      className="my-8 flex flex-row items-center justify-between px-3 font-sen"
      id="personal"
    >
      <div className="mr-4">
      ...
      <div>
        ...
        <div className="text-white" id="contact">
          <div className="pb-10">
            <div className="w-full border-b border-gray-500">
              <h1 className="py-4 text-6xl font-bold">Contact</h1>
            </div>
          </div>
          <div className="font-sen">
            ...
            <div className="my-8 flex flex-row gap-x-4">
              ...
              <Icon
                icon={<MdEmail />}
                url="mailto:saifulislam84210@gmail.com"
              />
              ...
              <Icon
                icon={<SiLinkedin />}
                url="https://linkedin.com/in/suislam"
              />
            </div>
          </div>
